...
for link in course_links:
    ...
    # extract course type
    buttons = driver.find_elements(By.XPATH, '//a[contains(@class, "ComparisonTable_comparisonButton")]')
    full_time = False
    flex = False
    ...
    description.append(driver.find_element(By.XPATH, '//pre[contains(@class, "SalarySection_aboutProfession")]').text)
    topics_count.append(driver.find_element(By.XPATH,'//div[contains(@class, "CourseProgram_purple__STsuM")]//p[contains(@class, "FactBlock_factNumber__d_8nn")]').text)
